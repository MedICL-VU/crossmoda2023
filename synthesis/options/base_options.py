...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='basic', choices=['basic'], help='specify generator architecture')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='unaligned3D', help='chooses how datasets are loaded. [unaligned3D]')
